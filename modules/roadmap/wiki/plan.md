...
> The authoritative order, dependencies, and acceptance criteria. Structural changes and completion calls need the human's approval; every such change gets a `plan |` entry in [[log]]. Story IDs are stable — append or sub-number (`S1.2.1`), never renumber.

## Milestones

*(none defined yet — add a short table here when the big outcomes take shape)*
